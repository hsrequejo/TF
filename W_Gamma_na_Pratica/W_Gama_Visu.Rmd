...
Mas afinal, quais valores devo escolher para os parâmetros? A resposta mais correta é: depende. Depende do queremos enxergar e qual insigth queremos obter. Por exemplo, se quisermos verificar quais são os “grandes módulos” \textbf{[exemplo ecologico?]} da rede devemos usar um valor de $\gamma$ mais baixo, caso quisermos encontrar módulos menores (mais “íntimos”) \textbf{[exemplo ecologico?]}, um $\gamma$ maior seria o mais indicado. Já se quisermos que as conexões de uma camada influenciem mais sobre a outra camada \textbf{[exemplo ecologico?]}, use um $\omega$ mais baixo, coso contrario, por exemplo \textbf{[exemplo ecologico?]}, melhor usar um $\gamma$ mais alto. Interpretação, conhecimento específico da área e saber o que queremos enxergar são os fatores principais para a escolha dos valores de $\omega$ e $\gamma$
